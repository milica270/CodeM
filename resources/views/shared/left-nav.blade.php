...
<div class="card mt-3 mb-3 p-3">
    ...
    <div class="d-flex align-items-center mt-2">
        <img src="{{$userWithMostLikes != null ? $userWithMostLikes->getImageURL() : '' }}" class="img-fluid rounded-circle" style="width: 25%" alt="">
        <strong class="ms-1"><a href="{{route('users.show', $userWithMostLikes != null ? $userWithMostLikes->id : '' )}}" style="color: rgb(52, 58, 64)">{{$userWithMostLikes != null ? $userWithMostLikes->name : '' }}</a></strong>
    </div>
    @endif
</div>
